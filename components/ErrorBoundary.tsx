...
${errorInfo?.componentStack || 'No component stack available'}
    ...
    public render() {
            ...
            return (
                <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 flex items-center justify-center p-4">
                    <div className="max-w-2xl w-full">
                        <div className="bg-slate-800 rounded-lg shadow-2xl border border-red-900/50 p-8">
                            ...
                            <div className="space-y-3">
                                <button
                                    ...
                                    className="w-full bg-brand-primary hover:bg-brand-primary/80 text-white font-semibold py-3 px-6 rounded-lg transition-colors"
                                >
                                    Try Again
                                </button>
                                <button
                                ...
                                <button
                                    ...
                                    className="w-full bg-slate-700 hover:bg-slate-600 text-slate-300 font-semibold py-2 px-6 rounded-lg transition-colors text-sm"
                                >
                                    Copy Error Details
                                </button>
                            </div>
        ...
        if (level === 'feature') {
            return (
                <div className="bg-slate-800 rounded-lg border border-red-900/30 p-6 m-4">
                    <div className="flex items-start space-x-4">
                        ...
                        <div className="flex-1">
                            ...
                            <div className="flex space-x-3">
                                <button
                                    onClick={this.handleRetry}
                                    className="bg-brand-primary hover:bg-brand-primary/80 text-white text-sm font-semibold py-2 px-4 rounded transition-colors"
                                >
                                    Retry
                                </button>
                                <button
                                    onClick={this.handleCopyError}
                                    className="bg-slate-700 hover:bg-slate-600 text-slate-300 text-sm font-semibold py-2 px-4 rounded transition-colors"
                                >
                                    Copy Error
                                </button>
                            </div>
        ...
        return (
            <div className="bg-red-900/10 border border-red-900/30 rounded-lg p-4 m-2">
                <div className="flex items-center justify-between">
                    ...
                    <button
                        onClick={this.handleRetry}
                        className="bg-slate-700 hover:bg-slate-600 text-white text-xs font-semibold py-1 px-3 rounded transition-colors"
                    >
                        Retry
                    </button>
                </div>
