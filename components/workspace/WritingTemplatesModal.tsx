                    ...
                    <div className="flex-1 p-6 overflow-y-auto max-h-[90vh]">
                        {!selectedTemplate ? (
                            <div className="text-center py-20">
                                ...
                                <p className="text-gray-600">Choose a writing template to see its structure and customize it for your project.</p>
                            </div>
                        ) : (
                            <div className="space-y-6">
                                ...
                                {/* Customization */}
                                <Card className="p-6">
                                    <h3 className="text-lg font-semibold text-gray-800 mb-4">Customize Your Project</h3>
                                ...
                                {/* Chapter Structure */}
                                <Card className="p-6">
                                    <h3 className="text-lg font-semibold text-gray-800 mb-4">Chapter Structure</h3>
                                    <div className="space-y-3">
                                        {selectedTemplate.structure.map(chapter => (
                                            <div key={chapter.chapterNumber} className="p-3 bg-gray-100/50 rounded-lg">
                                                ...
                                                <p className="text-sm text-gray-600 mb-2">{chapter.purpose}</p>
                                ...
                                {/* Character Guides */}
                                <Card className="p-6">
                                    <h3 className="text-lg font-semibold text-gray-800 mb-4">Character Development Guide</h3>
                                    <div className="space-y-4">
                                        {selectedTemplate.characterGuides.map(guide => (
                                            <div key={guide.id} className="p-3 bg-gray-100/50 rounded-lg">
                                                <h4 className="font-medium text-gray-800 capitalize mb-2">{guide.role}</h4>
                                                <div className="space-y-2 text-sm">
                                                    <div>
                                                        <span className="text-gray-700 font-medium">Development Areas:</span>
                                                        <p className="text-gray-600">{guide.developmentAreas.join(', ')}</p>
                                                    </div>
                                                    <div>
                                                        <span className="text-gray-700 font-medium">Key Questions:</span>
